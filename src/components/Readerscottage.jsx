                  ...
                  <div className="col-lg-3">
                    <div className="swiper_left">
                      ...
                      >
                        ...
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage4}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage5}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        ...
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage7}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage8}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage9}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage10}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage11}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage12}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage13}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage14}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage15}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage16}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage17}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage18}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage19}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage20}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage21}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage22}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage23}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage24}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage25}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage26}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage27}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                        <SwiperSlide>
                          <img
                            src={images.Readerscottage28}
                            className="img-fluid"
                          />
                        </SwiperSlide>
                      </Swiper>
                    ...
                    <div id="info_section">
                      ...
                      <div className="dicription_area mt-4">
                        ...
                        <div className="conten_decipt">
                          With stunning views from every room, Readers is a cozy
                          2 bedroom cottage with attached toilets, a living room
                          cum dinning area, a private sit-out, garden and some
                          special reading corners. Our staff of 5 will ensure
                          your stay is comfortable in every way. While we have
                          high speed Internet at Readers, Smart TV's
                          (Netflix...), Tata Sky you must know that regular
                          phone network is sparse, except for Jio which works in
                          some parts. However, Whatapp, FaceTime etc work very
                          well.
                          {togglecontentshow && (
                            <div className="gaust_list1">
                              We are pet-friendly.
                              <br />
                              Our Chef is trained in Indian, Chinese, Italian
                              and Continental cuisines. So whether you enjoy
                              pancakes or parathas on bright sunny mornings,
                              pizzas or chilly chicken on sun kissed afternoons,
                              or momos or barbecues on starlit nights, we’ve got
                              you. We recommend you definitely try the Banoffee
                              pie and chocolate cake :
                              <br />
                              For those of you looking for a workcation, we have
                              high speed Internet at Sundays. And for the rest,
                              we have TataSky and smart TVs (so you never miss a
                              match) <br />
                              For those of you looking for a workcation, we have
                              high speed Internet at Sundays. And for the rest,
                              we have TataSky and smart TVs (so you never miss a
                              match) On the other hand, if you’re looking for a
                              digital detox, we have books, Bluetooth speakers,
                              monopoly, chess, scrabble and much more on site;
                              nature lovers can go trekking, enjoy serene walks
                              or visit the Jabarkhet Nature Reserve which is
                              less than 10kms away; souvenir seekers can take a
                              30 minute drive to Mussoorie, Dhanaulti or
                              Landour. This is a main road property, so access
                              any time, day or night is convenient. So dust out
                              your cameras and make space on your phones, so
                              your memories at Sundays last forever
                            </div>
                          )}
                          <Link
                            onClick={() => {
