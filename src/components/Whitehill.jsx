                ...
                <div className="col-lg-9">
                  ...
                  <div className="hding_title">
                    ...
                    <p className="mb-2">
                      ...
                      <AiFillStar />
                      <AiFillStar />
                      <AiFillStar /> Mussoorie Rd, Next to St George's College and JP Hotel, Barlowsgang Mussoorie, Uttarakhand, India
                    </p>
                  </div>
                </div>
                <div className="col-lg-3">
                ...
                <div className="col-lg-11 col-sm-11 col-md-11">
                  <div id="info_section">
                    ...
                    <div className="dicription_area mt-4">
                      ...
                      Gorgeous views, outstanding food at the Fay Cafe (best thin crust pizzas/pastas/Tandoori live counter) and hospitality that will make you come back to us. Centrally located on main Barlowsganj Mussoorie Rd, 2.5 km from Mall Road, next to JP Hotel, our location will make you fall in love with hill stations again. Big Plus: 1.2 km before Mussoorie so you avoid the huge traffic jams. Drop/pick up
                        {togglecontentshow && (
                          <div className="gaust_list1">
                          services to Mall Rd. At WhiteHill Hotel by SundaysForever we offer rooms/cottages. Imp: There are steps at all levels. White Hill has 14 rooms and cottages: 8 - Deluxe Room : Double beds with mountain views 2 - Suite : Double beds and an additional living area 1 - Family Room : Two Double Bed and a living area in a spacious room, perfect for a family with 2 children 2 - Premium Room with Garden and Mountain View: Private garden space that is shared with two Premium rooms, at a different level. 1 - Queens Cottage: A private one bedroom Cottage with a living space, private sit out and open areas to soak in the sun while enjoying the mountain views
                          </div>
                        )}
