                ...
                <div className="col-lg-3">
                  <div className="swiper_left">
                    ...
                    >
                      ...
                      <SwiperSlide>
                        <img
                          src={images.hilltopimg5}
                          className="img-fluid"
                        />
                      </SwiperSlide>
                      <SwiperSlide>
                        <img
                          src={images.hilltopimg6}
                          className="img-fluid"
                        />
                      </SwiperSlide>
                      <SwiperSlide>
                        <img
                          src={images.hilltopimg7}
                          className="img-fluid"
                        />
                      </SwiperSlide>
                      <SwiperSlide>
                        <img
                          src={images.hilltopimg8}
                          className="img-fluid"
                        />
                      </SwiperSlide>
                      <SwiperSlide>
                        <img
                          src={images.hilltopimg9}
                          className="img-fluid"
                        />
                      </SwiperSlide>
                      <SwiperSlide>
                        <img
                          src={images.hilltopimg10}
                          className="img-fluid"
                        />
                      </SwiperSlide>
                      <SwiperSlide>
                        <img
                          src={images.hilltopimg11}
                          className="img-fluid"
                        />
                      </SwiperSlide>
                      <SwiperSlide>
                        <img
                          src={images.hilltopimg12}
                          className="img-fluid"
                        />
                      </SwiperSlide>
                      <SwiperSlide>
                        <img
                          src={images.hilltopimg13}
                          className="img-fluid"
                        />
                      </SwiperSlide>
                      <SwiperSlide>
                        <img
                          src={images.hilltopimg14}
                          className="img-fluid"
                        />
                      </SwiperSlide>
                    </Swiper>
                ...
                <div className="col-lg-11 col-sm-11 col-md-11">
                  <div id="info_section">
                    ...
                    <div className="dicription_area mt-4">
                      ...
                      Enjoy the air and behold the Mountains!
Perched high on the mountainside, this cozy cottage is a showcase to the beauty of the Garhwali Mountains.. <br />
...
With an inviting bedroom & living room, put together with a lot of love, Hill Top Cottage is an intimate spot for two. A place built for relaxation, the cottage has an outside seating space and a garden.
                          </div>
                        )}
